    ...
    return (
        <div className='max-w-6xl md:mx-auto flex ml-5 mr-5 flex-col md:flex-row'>
            ...
            <Marquee direction="right" pauseOnHover={true} className='border-2 border-indigo-600 px-5 py-2'>
                <Link href="#" className='hover:text-indigo-800'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem esse sit at ab ut quos rem, quibusdam impedit tempora molestias non corrupti dolorum illum libero repellendus dolore, dolor fuga expedita!</Link>
