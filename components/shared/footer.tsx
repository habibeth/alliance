                ...
                <div className="text-white">
                    ...
                    <div className="grid md:grid-cols-2">
                        <div className="">
                            <ul>
                                <li className="my-2">
                                    <Link href="#" className="underline">Alliance At Glance</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Clients</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Sewing</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Knitting</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Dyeing</Link>
                                </li>
                            </ul>
                        </div>
                        <div className="">
                            <ul>
                                <li className="my-2">
                                    <Link href="#" className="underline">Fabric R&D</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Design Hub</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Sustainability</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Media</Link>
                                </li>
                                <li className="my-2">
                                    <Link href="#" className="underline">Career</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
